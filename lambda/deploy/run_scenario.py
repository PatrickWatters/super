...
if __name__ == '__main__':
    try:
        run_scenario(
            boto3.client('lambda'), boto3.resource('iam'), '/Users/patrickwatters/Projects/SDL/src/lambdaapp/lambda_handler_basic.py',
            '/Users/patrickwatters/Projects/SDL/src/lambdaapp/lambda_handler_calculator.py', 'doc_example_lambda_calculator')
    except Exception:
